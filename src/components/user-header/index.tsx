            ...
            <div className="flex space-x-2 lg:space-x-6 text-sm">
                {menu.map(item => {
                    ...
                    return (
                        ...
                        <div className={`header-icon font-medium text-[#2c2c2c] flex px-4 py-3 bg-white justify-center items-center rounded-lg ease-in-out transition duration-300 cursor-pointer hover:bg-indigo-100 hover:text-indigo-600 ${pathname === item.link ? 'active' : ''}`}>
                            <Icon className='mr-2' />
